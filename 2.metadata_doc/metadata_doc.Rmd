---
title: "Cocos and Terminalia Predispersal Seed Predation"
author: "Alex Wegmann"
...
<!--_Include what, where, and when in the dataset title_-->
 - Cocos predispersal seed predation 2005
 - Terminalia predispersal seed predation 2005
...
## 4. Creators
_Should anyone else besides you have the role of creator? All creators are part of the citation of the data._
...
_You are the contact point for this data. But is there anyone else that should be listed under any specific role. These people are mention in the metadata but are not part of the citation._
...
Description <- c("2005-08-10", "2005-11-02", "Completed")
...
cat_vars <- read.delim2(here::here(paste0("3.data_attributes/catvars_", files_names$file_name[1],".txt")))
